...
#   omni_endpoint     — Omni gRPC host:port (e.g. omni.REDACTED_TAILNET_DOMAIN:8090)
...
variable "omni_endpoint" {
  description = "Omni gRPC endpoint for SideroLink, e.g. omni.REDACTED_TAILNET_DOMAIN:8090. Required when omni_ready = true."
  type        = string
  default     = null
}
