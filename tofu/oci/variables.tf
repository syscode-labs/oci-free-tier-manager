...
#   omni_machine_config — official Talos config fragment from `omnictl jointoken machine-config`
...
# ---------------------------------------------------------------------------
variable "omni_ready" {
  description = "When true, provision Talos+Omni nodes instead of Ubuntu. Requires talos_image_ocid, omni_machine_config, tailscale_auth_key."
  type        = bool
  default     = false
}

variable "omni_machine_config" {
  description = "Official multi-document Talos machine-config fragment from `omnictl jointoken machine-config`. Required when omni_ready = true. Store as GitHub secret OMNI_MACHINE_CONFIG."
  type        = string
  sensitive   = true
  default     = null
}
...
variable "omni_endpoint" {
  description = "Legacy Omni endpoint base URL. Prefer omni_machine_config generated by `omnictl jointoken machine-config`."
  type        = string
  default     = null
}

variable "omni_join_token" {
  description = "Legacy static SideroLink join token. Prefer omni_machine_config generated by `omnictl jointoken machine-config`."
  type        = string
  sensitive   = true
  default     = null
}
...
variable "omni_api_port" {
  description = "Omni machine API TCP port from `omnictl jointoken machine-config` SideroLinkConfig."
  type        = number
  default     = 8090
}
