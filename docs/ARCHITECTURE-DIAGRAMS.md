...
flowchart TB
    ...
    classDef phaseNode fill:#15803d,stroke:#22c55e,stroke-width:3px,color:#fff,font-size:14px
...
flowchart TB
    ...
    classDef layer1 fill:#2563eb,stroke:#3b82f6,stroke-width:2px,color:#fff
    classDef layer2 fill:#7c3aed,stroke:#a855f7,stroke-width:2px,color:#fff
    classDef layer3 fill:#0891b2,stroke:#06b6d4,stroke-width:2px,color:#fff
